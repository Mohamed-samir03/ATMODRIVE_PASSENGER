...
class PassengerAccountInformationFragment : Fragment() {

    private var _binding: FragmentPassengerAccountInformationBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPassengerAccountInformationBinding.inflate(inflater, container, false)
        return binding.root
    }
